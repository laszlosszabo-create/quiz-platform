          ...
          <div className="p-4">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-300 text-gray-900 placeholder-gray-500 text-sm"
                    required
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-md flex items-center justify-center space-x-1"
              >
                {isSubmitting ? (
                  <>
              ...
              <div className="space-y-2">
                {translations.email_gate_privacy_text && (
                  <p className="text-xs text-gray-600 text-center bg-gray-50 p-2 rounded-lg">
