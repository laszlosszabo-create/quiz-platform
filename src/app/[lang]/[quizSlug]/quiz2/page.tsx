...
export async function generateMetadata({ params }: QuizPageProps): Promise<Metadata> {
  ...
  const title = `${translations.landing_headline || 'Quiz'} - Questions (Mobile)`

  return {
    title,
    description: 'Answer the questions to get your personalized results - Mobile optimized version.',
  }
}
